...
export default function PageRenderer({ format, page }: PageRendererProps) {
  ...
  return (
    <div
      class="bg-white shadow-xl relative overflow-hidden shrink-0"
      style={{
        ...
        boxShadow: "0 10px 30px rgba(0,0,0,0.1), 0 1px 3px rgba(0,0,0,0.05)", // Subtle book-like shadow
      }}
    >
      ...
      >
        ...
        {page.layout_style === "single_quote_large" && page.quote && (
          <div class="text-center">
            <h2
              class="text-gray-800 font-serif leading-relaxed"
              // Simple scaling logic for fonts based on format
              style={{ fontSize: format === "mini" ? "1.5rem" : "2.2rem" }}
            >
              "{page.quote.text}"
            </h2>
            <div class="mt-6 text-gray-500 font-sans tracking-wide uppercase text-sm">
